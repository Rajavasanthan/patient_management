...
function DashboardLayout() {
  let logout = () => {
    window.localStorage.removeItem(import.meta.env.VITE_LOCAL_STORAGE_KEY);
      ...
      >
        <div className="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
          <ul className="space-y-2 font-medium">
            ...
            <li className="fixed bottom-0 left-0 w-64 border-t border-gray-200 dark:border-gray-700">
              <button
                onClick={logout}
